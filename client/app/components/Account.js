            ...
            />
            {
                user && user ?
                    <>
                        ...
                        <Text style={{ color: 'black', marginTop: 15, fontSize: 18 }}>test@gmail.com</Text>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', width: width / 1.2, alignItems: 'center', marginTop: 25 }}>
                            <View
                                style={{ textAlign: 'center', justifyContent: 'center', }}
                            >
                                <Text style={{ color: 'white', fontSize: 18 }}>sold</Text>
                                <Text style={{ color: 'white' }}>{user.solde}</Text>
                            </View>
                            <View>
                                <Text style={{ color: 'white', fontSize: 20 }}>|</Text>
                            </View>
                            <View>
                                <Text style={{ color: 'white', fontSize: 18 }}>{user.localCrncy}</Text>
                            ...
                            <View>
                                <TouchableOpacity onPress={() => history.push({
                                    ...
                                    <Text style={{ color: 'white', fontSize: 18 }}>sale</Text>
                                </TouchableOpacity>
                            </View>
                        ...
                        >
                            ...
                            <Text style={{ color: '#93a6b1', fontSize: 18, marginVertical: 15 , textAlign: 'center'}}>log out</Text>
                        </TouchableOpacity>
                    </>
